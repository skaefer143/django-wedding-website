...
from guests.views import GuestListView, test_email, save_the_date_preview, save_the_date_random, export_guests, \
    ...
    follow_up_email_preview, follow_up_email_test, reminder_email_preview, reminder_email_test, thank_you_email_preview, \
    thank_you_email_test
...
urlpatterns = [
    ...
    url(r'^reminder-email/(?P<invite_id>[\w-]+)/$', reminder_email_preview, name='reminder-email'),
    url(r'^reminder-email-test/(?P<invite_id>[\w-]+)/$', reminder_email_test, name='reminder-email-test'),
    url(r'^thank-you-email/(?P<invite_id>[\w-]+)/$', thank_you_email_preview, name='thank-you-email'),
    url(r'^thank-you-email-test/(?P<invite_id>[\w-]+)/$', thank_you_email_test, name='thank-you-email-test'),
